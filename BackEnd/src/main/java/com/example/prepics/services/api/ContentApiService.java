...
public class ContentApiService {
    ...
    public ResponseEntity<?> uploadContent(Authentication authentication, MultipartFile file, ContentDTO contentDTO)
        ...
        try {
            ...
            String label = isImage ? classifyImageWithFlaskAPI(tempFile) : classifyVideoWithFFmpeg(tempFile);
    ...
    private String classifyImageWithFlaskAPI(File file) {
        ...
        try {
            Mono<Map> response = webClient.post()
                    ...
                    .body(BodyInserters.fromMultipartData("file", new FileSystemResource(file.getAbsolutePath())))
                    .retrieve()
