...
public class UserApi {
     ...
     * - Tìm kiếm người dùng trong hệ thống qua email.
     * - Nếu người dùng chưa tồn tại, sẽ được tạo mới.
     *
...
//    @Guest
     ...
     * - Nếu là admin, trả về danh sách tất cả người dùng.
     ...
     * - Nếu tìm thấy, xóa người dùng và trả về kết quả thành công.
     ...
     * - Nếu người dùng và người được theo dõi tồn tại, tạo liên kết "theo dõi" (Followees) và "bị theo dõi" (Followers).
     * - Trả về kết quả thành công nếu theo dõi thành công.
     *
     * @param authentication: Thông tin người dùng hiện tại đã đăng nhập.
     ...
     * Quy trình xử lý:
     * - Kiểm tra xem người dùng hiện tại có tồn tại trong hệ thống không.
     * - Xóa liên kết theo dõi và bị theo dõi giữa hai người dùng.
     * - Trả về kết quả thành công nếu bỏ theo dõi thành công.
     *
     * @param authentication: Thông tin người dùng hiện tại đã đăng nhập.
